...
public class BroadcastConfig {
    ...
    public final static String FANOUT_QUEUE_1_ASYN_NAME = "com.baeldung.spring-amqp-simple.fanout.asyn.queue1";
    public final static String FANOUT_QUEUE_2_NAME = "com.baeldung.spring-amqp-simple.fanout.queue2";
    public final static String FANOUT_QUEUE_2_ASYN_NAME = "com.baeldung.spring-amqp-simple.fanout.asyn.queue2";
    ...
    public Declarables fanoutBindings() {
        ...
        Queue fanoutAsynQueue1 = new Queue(FANOUT_QUEUE_1_ASYN_NAME, NON_DURABLE);
        Queue fanoutQueue2 = new Queue(FANOUT_QUEUE_2_NAME, NON_DURABLE);
        Queue fanoutAsynQueue2 = new Queue(FANOUT_QUEUE_2_ASYN_NAME, NON_DURABLE);

        FanoutExchange fanoutExchange = new FanoutExchange(FANOUT_EXCHANGE_NAME, NON_DURABLE, false);

        return new Declarables(fanoutQueue1, fanoutAsynQueue1, fanoutQueue2, fanoutAsynQueue2, fanoutExchange, BindingBuilder
                .bind(fanoutQueue1)
                .to(fanoutExchange), BindingBuilder
                .bind(fanoutQueue2)
                .to(fanoutExchange), BindingBuilder
                .bind(fanoutAsynQueue1)
                .to(fanoutExchange), BindingBuilder
                .bind(fanoutAsynQueue2)
                .to(fanoutExchange));
    }
